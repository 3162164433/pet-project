...
import goodsDetail from '@/components/front/GoodsDetail.vue';
Vue.use(VueRouter)
...
const routes = [
...

  {
    ...
    children: [
      ...
      {        path:'/petGoods',        name: 'petGoods',        component:petGoods,      },      {        path:'/goodsDetail/:id',        name: 'goodsDetail',        component:goodsDetail,      },
      {        path:'/front/forum',        name: 'forumIndex',        component: () => import('../views/forum/ForumIndex.vue'),      },
      {        path:'/front/forum/post/:id',        name: 'postDetail',        component: () => import('../views/forum/PostDetail.vue'),      },
      {
        // 服务
        path:'/petServices',
        name: 'petServices',
